    ...
    <div className="col-0 col-xl-2 px-sm-2 px-0 bg-dark d-none d-md-none d-xl-block position-fixed">
      <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100 ">
        <div className="navbar-header text-center my-4">
          <img src="https://raw.githubusercontent.com/feii07/portfolio/master/public/img/profile/profile.jpg" className="rounded-circle mx-auto d-block img-fluid center-block h-profile my-3" alt="fera" />
